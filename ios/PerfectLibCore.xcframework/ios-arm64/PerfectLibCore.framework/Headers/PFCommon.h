...
typedef NS_ENUM (NSInteger, PFFunctionality) {
    ...
    /// The ability to apply jewelry function
    PFFunctionalityJewelry,
...
/**
 The ring position on specific hand
 */
typedef NS_ENUM(NSUInteger, PFRingPosition) {
    PFRingPositionThumb = 0,
    PFRingPositionForeFinger,
    PFRingPositionMiddleFinger,
    PFRingPositionRingFinger,
    PFRingPositionLittleFinger,
};
